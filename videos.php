...
<body>
                    ...
                    <div class="page_breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item text-white">Videos</li>
                            </ol>
                        </nav>
                    </div>
                </div>
    ...
    <section class="container noticias" id="noticias">

        <div class="row">

            <div class="col-md-4 my-4 px-4">
                <a href="" class="card border-0 shadow h-100">
                    <img src="./public/img/galeria/noticia3.png" width="100%" height="280">
                    <div class="card-body">
                        <h5 class="text-center fw-bold">
                            Video 1
                        </h5>
                        <div class="detalle">
                            Lorem ipsum dolor sit amet consectetur adipi amet consectetur adipi
                        </div>
                    </div>
                    <div class="card-footer text-warning">
                        <i class="far fa-calendar-alt"></i> <span class="ms-2">10-01-2023</span>
                    </div>
                </a>
            </div>
            <div class="col-md-4 my-4 px-4">
