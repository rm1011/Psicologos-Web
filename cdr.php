                    ...
                    <div class="page_breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item text-white">Consejos Directivos Regionales</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="row justify-content-between">
            <div class="col">
                <div>
                    ...
                    <p>
                        Inscripción de Personas Jurídicas Creadas por Ley <br>
                        Colegio de psicólogos del Perú <br>
                        Oficina registral de Lima y Callao <br>
                        Oficina Lima <br>
