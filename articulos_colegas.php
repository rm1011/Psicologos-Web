                    ...
                    <div class="page_breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item text-white">Articulos de Colegas</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="col-lg-12 my-4">
                <div class="row">
                    <div class="col-md-4 my-3">
                        <a href="" class="card h-100 shadow-sm">
                            ...
                            <div class="card-footer d-flex flex-row align-items-center bg-white px-3 py-2">
                                <div>
                                    ...
                                    <span class="ms-1" style="font-size: 16px;">01-01-2023</span>
                                </div>
                            </div>
                        </a>
                    </div>
                    <div class="col-md-4 my-3">
                        <a href="" class="card h-100 shadow-sm">
                            ...
                            <div class="card-footer d-flex flex-row align-items-center bg-white px-3 py-2">
                                <div>
                                    <i class="far fa-calendar-alt"></i>
                                    <span class="ms-1" style="font-size: 16px;">11-10-2022</span>
                                </div>
                            </div>
                        </a>
                    </div>
                    <div class="col-md-4 my-3">
                        <a href="" class="card h-100 shadow-sm">
                            ...
                            <div class="card-footer d-flex flex-row align-items-center bg-white px-3 py-2">
                                <div>
                                    <i class="far fa-calendar-alt"></i>
                                    <span class="ms-1" style="font-size: 16px;">01-09-2022</span>
                                </div>
                            </div>
                        </a>
                    </div>
