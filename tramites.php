            ...
            <div class="col-lg-6">
                <div>
                    ...
                    <p class="text-justify">
                        Todo trámite es personal, pueden visitarnos en nuestra sede en Jr. Camilo Carrillo164 - Jesús María.
                    </p>
                    <p>Brindamos trámites de:</p>

                    <ul>
                        <li> <i class="fas fa-check"></i> Colegiatura</li>
                        <li> <i class="fas fa-check"></i> Registro de Especialidades.</li>
                        <li> <i class="fas fa-check"></i> Pago De Aportaciones.</li>
                        <li> <i class="fas fa-check"></i> Duplicado de carné de Colegiado.</li>
                        <li> <i class="fas fa-check"></i> Constancia de Habilitación.</li>
                        <li> <i class="fas fa-check"></i> Certificados psicológicos.</li>
                    </ul>

                    <p>Para más información contactarnos a <b> 01 3305390 </b> </p>
                </div>
            </div>
        </div>
    </section>
