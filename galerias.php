        ...
        <div class="row pt-4">
            ...
            <div class="col-lg-4 px-3 py-5">
                <div class="card h-100 shadow">
                    <img src="./public/img/galeria/galeria_navidad.jpg" width="100%" height="200" style="object-fit: cover;">
                    <div class="card-body pb-2 text-center">
                        <a href="galeriav1.php">Galería - NAVIDAD</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 px-3 py-5">
                <div class="card h-100 shadow">
                    <img src="./public/img/galeria/galeria_colegiatura.jpg" width="100%" height="200" style="object-fit: cover;">
                    <div class="card-body pb-2 text-center">
                        <a href="galeriav2.php">Galería - COLEGIATURA DICIEMBRE 2022</a>
                    </div>
                </div>
            </div>
