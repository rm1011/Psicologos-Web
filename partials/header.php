                ...
                <ul class="navbar-nav mt-2 mt-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownId">
                            ...
                            <a class="dropdown-item" href="phabilitados.php">Psicólogos Habilitados</a>
                            <a class="dropdown-item" href="tramites.php">Trámites</a>
                            <a class="dropdown-item" href="convenios.php">Convenios</a>
                            <a class="dropdown-item" href="cagrupaciones.php">Coordinación de agrupaciones</a>
                            <a class="dropdown-item" href="cuniversitarios.php">Coordinación con universitarios</a>

                        </div>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link fw-bold <?= $active4 ?>" href="" id="dropdownId" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="me-2">CENTRO DE CAPACITACIÓN</span><i class="fas fa-caret-down"></i></a>
                        <div class="dropdown-menu" aria-labelledby="dropdownId">
